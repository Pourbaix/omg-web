...
To use the application locally on your computer, you need to first download both the frontend and the backend part of the application by using the `git clone` command:
